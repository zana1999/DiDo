    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Regroup</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">New groups preview</li>
                </ol>
                <div class="row">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-columns">
                        <form action="/DiDo/public/Regroup" method="POST">
@csrf
                        <table class="table table-striped">
                            ...
                            @foreach($groups  as $key=>$grp )
                                <tr>
                                    ...
                                    <td><input type="text" name="name[]" value="{{$key}} " readonly></td>
                                    <td><input type="text" name="grp[]" value="{{$grp}}"></td>
