...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-primary text-white mb-4">
                            <div class="card-body">Groupes</div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-warning text-white mb-4">
                            <div class="card-body">Lecturers and Classes</div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="#">View Details</a>
                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-success text-white mb-4">
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="{{route('students')}}">View Details</a>
                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                            </div>
                        </div>
                    </div>
            ...
            @can('isadmin')
                <div class="card mb-1" style="width:1000px;">
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach(\App\Posts::all() as $post)
                                <tr>
                                    ...
                                    <td>{{$post->std_name}}</td>
                                    <td>{{$post->current_group}}</td>
                                    <td>{{$post->requested_group}}</td>
                                    <td>{{$post->message}}</td>
                                    <td>

                                        <form action="/DiDo/public/posts/{{$post->id}}" method="POST">
                                            @csrf
                                            @method("DELETE")
